...
import com.dailylocally.ui.category.l2.products.FavRequest;
...
public class CollectionProductsItemViewModel {
    ...
    private final CollectionProductsResponse.Result products;
    ...
    public CollectionProductsItemViewModel(ProductsItemViewModelListener mListener, CollectionProductsResponse.Result result) {
