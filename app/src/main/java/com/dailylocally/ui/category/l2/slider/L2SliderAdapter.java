...
/*public class L2SliderAdapter extends SliderViewAdapter<BaseViewHolder> {
    ...
    public class SliderViewHolder extends BaseViewHolder implements SliderItemViewModel.SliderItemViewModelListener {
        ListItemSliderBinding mListItemLiveProductsBinding;
        SliderItemViewModel mFilterItemViewModel;
