...
public class AddressTypeActivity extends BaseActivity<ActivitySplashBinding, AddressTypeViewModel>
        implements AddressTypeNavigator {

    @Inject
    AddressTypeViewModel mAddressTypeViewModel;
    Analytics analytics;
    ...
    public static Intent newIntent(Context context) {
        return new Intent(context, AddressTypeActivity.class);
    }
    ...
    public void checkForUserLogin(boolean status) {
        if (status) {
            Intent intent = MainActivity.newIntent(AddressTypeActivity.this, AppConstants.NOTIFY_HOME_FRAG, AppConstants.NOTIFY_SPLASH_ACTV);
           ...
           /* SharedPreferences settings = getSharedPreferences(AppConstants.PREF_NAME, Context.MODE_PRIVATE);
            ...
            Intent intent = SignUpActivity.newIntent(AddressTypeActivity.this);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        }
    ...
    public void update(boolean updateStatus, boolean forceUpdateStatus) {
        ...
        if (forceUpdateStatus) {
            Intent intent = UpdateActivity.newIntent(AddressTypeActivity.this);
            intent.putExtra("forceUpdate", forceUpdateStatus);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        } else {
            mAddressTypeViewModel.checkIsUserLoggedInOrNot();
        }
    }
    ...
    public void userAlreadyRegistered(boolean status) {
        if (!status) {
            Intent intent = RegistrationActivity.newIntent(AddressTypeActivity.this);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        }
    ...
    public void userAddressActivity() {
        Intent intent = GoogleAddressActivity.newIntent(AddressTypeActivity.this);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(intent);
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddressTypeViewModel.setNavigator(this);
        ...
        try {
            ...
            mAddressTypeViewModel.version.set("v" + version);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    if (!prefManager.isFirstTimeLaunch()) {
                        Intent intent = OnBoardingActivity.newIntent(AddressTypeActivity.this);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                    } else {

                        mAddressTypeViewModel.checkUpdate();
