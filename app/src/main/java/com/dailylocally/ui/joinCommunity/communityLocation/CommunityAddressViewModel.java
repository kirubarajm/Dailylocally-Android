...
public class CommunityAddressViewModel extends BaseViewModel<CommunityAddressNavigator> {
    ...
    CommunityAddressRequestPojo request = new CommunityAddressRequestPojo();

    public CommunityAddressViewModel(DataManager dataManager) {
        super(dataManager);
    ...
    public void saveAddress(String locationAddress, String house, String area, String landmark/*, String title*/) {
        ...
        if (getNavigator().validationForAddress()) {
            ...
            if (!locationAddress.equals("") && !area.equals("") && !house.equals("") && !landmark.equals("")) {
                ...
                if (request == null) request = new CommunityAddressRequestPojo();
    ...
    public void checkAddress(String locationAddress, String area, String lat,
        ...
        try {
            setIsLoading(true);
            GsonRequest gsonRequest = new GsonRequest(Request.Method.POST, AppConstants.URL_CHECK_ADDRESS, CommunityAddressResponse.class, new CommunityAddressRequest(getDataManager().getCurrentUserId(), lat, lng), new Response.Listener<CommunityAddressResponse>() {
                @Override
                public void onResponse(CommunityAddressResponse response) {
                    if (!response.getStatus()) {
