...
public class CheckView extends View {
    ...
    private static final long CHECK_ANIM_DURATION = 800L;
    private static final long SCALE_ANIM_DELAY = 800L;
    ...
    private Paint createPaint(@ColorInt int color, float strokeWidth) {
        Paint p = new Paint();
       // p.setColor(color);
        LinearGradient shader = new LinearGradient(0, 0, 0, 150, getResources().getColor(R.color.dl_primary_color),  getResources().getColor(R.color.dl_green), Shader.TileMode.CLAMP);
        p.setShader(shader);
